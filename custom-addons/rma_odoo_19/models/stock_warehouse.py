...
class StockWarehouse(models.Model):
    ...
    rma_out_replace_route_id = fields.Many2one(
        "stock.route", "RMA out Replace Route"
    )
    ...
    def _get_rma_location_values(self, vals, code=False):
        ...
        return {
            ...
            "location_id": self.env.ref("rma_odoo_19.stock_location_rma").id,
    ...
    def _get_picking_type_create_values(self, max_sequence):
        ...
        rma_loc_id = self.rma_loc_id.id if self.rma_loc_id else False
        data.update(
            {
                "rma_in_type_id": {
                    ...
                    "default_location_dest_id": rma_loc_id,
                ...
                "rma_out_type_id": {
                    ...
                    "use_create_lots": False,
                    "use_existing_lots": True,
                    "default_location_src_id": rma_loc_id,
    ...
    def _create_or_update_sequences_and_picking_types(self):
        ...
        if "out_type_id" in data:
            rma_out_type = stock_picking_type.browse(data.get("rma_out_type_id"))
            rma_out_type.write(
